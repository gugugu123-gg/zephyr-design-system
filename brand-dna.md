...
| 色名 | 色值 | 对应 | 用途 |
|------|------|------|------|
| 蓝 | `#2B7FD8` | 头发 | 主色调、标题、超链接、重点标记 |
| 黄/金 | `#F4D758` | 裙子 | 强调、装饰、badges、连接线、高亮 |
| 红 | `#E84A5F` | 蝴蝶结/鞋 | 点缀、高亮下划线、CTA、标签 |
...
不二的固定视觉形象（character.png），以下元素不可更改：
...
### 素材文件
- **头像** — `assets/avatar.jpg`（蓝卷发+红蝴蝶结+圆框眼镜，适用于个人介绍区、头像集群等）
